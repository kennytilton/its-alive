...
(defn md-install-cell (self slot-name c &aux (c-isa-cell (typep c 'cell)))
  ;
...
(defn md-slot-cell-flushed (self slot-name)
  (if self
...
(defn md-owning-slots (self &aux (st (type-of self)))
...
(defn (setf md-slot-cell) (new-cell self slot-name)
...
(defn md-map-cells (self type celldo)
